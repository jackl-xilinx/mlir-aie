...
module @test_chess_04_deprecated_shim_dma_precompiled_kernel{
  ...
  %c13 = AIE.core(%t73) { 
    ...
    scf.for %iv = %lb to %ub step %step {
      ...
      AIE.useLock(%lock_73_a_ping, "Acquire", 1, 0) // acquire for read
      AIE.useLock(%lock_73_b_ping, "Acquire", 0, 0) // acquire for write
      call @dequant_8x8(%buf_73_aping, %buf_73_bping) : (memref<64xi16>, memref<64xi16>) -> ()
      AIE.useLock(%lock_73_a_ping, "Release", 0, 0) // release for write
      AIE.useLock(%lock_73_b_ping, "Release", 1, 0) // release for read

      AIE.useLock(%lock_73_a_pong, "Acquire", 1, 0) // acquire for read
      AIE.useLock(%lock_73_b_pong, "Acquire", 0, 0) // acquire for write
      call @dequant_8x8(%buf_73_apong, %buf_73_bpong) : (memref<64xi16>, memref<64xi16>) -> ()
      AIE.useLock(%lock_73_a_pong, "Release", 0, 0) // release for write
      AIE.useLock(%lock_73_b_pong, "Release", 1, 0) // release for read      
    }
    ...
    scf.for %iv = %lb to %ub step %step {
      ...
      AIE.useLock(%lock_74_a_ping, "Acquire", 1, 0) // acquire for read
      AIE.useLock(%lock_74_b_ping, "Acquire", 0, 0) // acquire for write
      call @pass(%buf_74_aping, %buf_74_bping) : (memref<64xi16>, memref<64xi16>) -> ()
      AIE.useLock(%lock_74_a_ping, "Release", 0, 0) // release for write
      AIE.useLock(%lock_74_b_ping, "Release", 1, 0) // release for read

      AIE.useLock(%lock_74_a_pong, "Acquire", 1, 0) // acquire for read
      AIE.useLock(%lock_74_b_pong, "Acquire", 0, 0) // acquire for write
      call @pass(%buf_74_apong, %buf_74_bpong) : (memref<64xi16>, memref<64xi16>) -> ()
      AIE.useLock(%lock_74_a_pong, "Release", 0, 0) // release for write
      AIE.useLock(%lock_74_b_pong, "Release", 1, 0) // release for read      
    }
    ...
    scf.for %iv = %lb to %ub step %step {
      ...
      AIE.useLock(%lock_75_a_ping, "Acquire", 1, 0) // acquire for read
      AIE.useLock(%lock_75_b_ping, "Acquire", 0, 0) // acquire for write
      call @pass(%buf_75_aping, %buf_75_bping) : (memref<64xi16>, memref<64xi16>) -> ()
      AIE.useLock(%lock_75_a_ping, "Release", 0, 0) // release for write
      AIE.useLock(%lock_75_b_ping, "Release", 1, 0) // release for read

      AIE.useLock(%lock_75_a_pong, "Acquire", 1, 0) // acquire for read
      AIE.useLock(%lock_75_b_pong, "Acquire", 0, 0) // acquire for write
      call @pass(%buf_75_apong, %buf_75_bpong) : (memref<64xi16>, memref<64xi16>) -> ()
      AIE.useLock(%lock_75_a_pong, "Release", 0, 0) // release for write
      AIE.useLock(%lock_75_b_pong, "Release", 1, 0) // release for read      
    }
  ...
  %m73 = AIE.mem(%t73) {
    ...
    ^bd0:
      AIE.useLock(%lock_73_a_ping, "Acquire", 0, 0)
      AIE.dmaBd(<%buf_73_aping : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_73_a_ping, "Release", 1, 0)
      br ^bd1
    ^bd1:
      AIE.useLock(%lock_73_a_pong, "Acquire", 0, 0)
      AIE.dmaBd(<%buf_73_apong : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_73_a_pong, "Release", 1, 0)
      br ^bd0
    ^bd2:
      AIE.useLock(%lock_73_b_ping, "Acquire", 1, 0)
      AIE.dmaBd(<%buf_73_bping : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_73_b_ping, "Release", 0, 0)
      br ^bd3
    ^bd3:
      AIE.useLock(%lock_73_b_pong, "Acquire", 1, 0)
      AIE.dmaBd(<%buf_73_bpong : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_73_b_pong, "Release", 0, 0)
      br ^bd2
    ^end:
      AIE.end
  }
  ...
  %m74 = AIE.mem(%t74) {
    ...
    ^dma0:
      %dstDma = AIE.dmaStart("MM2S1", ^bd2, ^end)
    ^bd0:
      AIE.useLock(%lock_74_a_ping, "Acquire", 0, 0)
      AIE.dmaBd(<%buf_74_aping : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_74_a_ping, "Release", 1, 0)
      br ^bd1
    ^bd1:
      AIE.useLock(%lock_74_a_pong, "Acquire", 0, 0)
      AIE.dmaBd(<%buf_74_apong : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_74_a_pong, "Release", 1, 0)
      br ^bd0
    ^bd2:
      AIE.useLock(%lock_74_b_ping, "Acquire", 1, 0)
      AIE.dmaBd(<%buf_74_bping : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_74_b_ping, "Release", 0, 0)
      br ^bd3
    ^bd3:
      AIE.useLock(%lock_74_b_pong, "Acquire", 1, 0)
      AIE.dmaBd(<%buf_74_bpong : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_74_b_pong, "Release", 0, 0)
      br ^bd2
    ^end:
      AIE.end
  }
  ...
  %m75 = AIE.mem(%t75) {
    ...
    ^dma0:
      %dstDma = AIE.dmaStart("MM2S1", ^bd2, ^end)
    ^bd0:
      AIE.useLock(%lock_75_a_ping, "Acquire", 0, 0)
      AIE.dmaBd(<%buf_75_aping : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_75_a_ping, "Release", 1, 0)
      br ^bd1
    ^bd1:
      AIE.useLock(%lock_75_a_pong, "Acquire", 0, 0)
      AIE.dmaBd(<%buf_75_apong : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_75_a_pong, "Release", 1, 0)
      br ^bd0
    ^bd2:
      AIE.useLock(%lock_75_b_ping, "Acquire", 1, 0)
      AIE.dmaBd(<%buf_75_bping : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_75_b_ping, "Release", 0, 0)
      br ^bd3
    ^bd3:
      AIE.useLock(%lock_75_b_pong, "Acquire", 1, 0)
      AIE.dmaBd(<%buf_75_bpong : memref<64xi16>, 0, 64>, 0)
      AIE.useLock(%lock_75_b_pong, "Release", 0, 0)
      br ^bd2
    ^end:
      AIE.end
  }
